...
$count_stmt = $pdo->prepare("SELECT COUNT(*) FROM orders WHERE customer_id = ? AND status != 'deleted'");
...
$stmt = $pdo->prepare("
    ...
    FROM orders o
    WHERE o.customer_id = ? AND o.status != 'deleted'
...
foreach ($orders as $order) {
    error_log("Order ID: " . $order['order_id'] . ", Status: " . $order['status']);
}
